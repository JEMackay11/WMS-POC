...
define(['N/record', 'N/search'],
    ...
    (record, search) => {
        ...
        const post = (requestBody) => {
            let arrVendorResults = [];
            let objVendorSearch = search.create({
                type: 'purchaseorder',
                filters: [
                    ['type', 'anyof', 'PurchOrd'],
                    'AND',
            ...
            return JSON.stringify(arrVendorResults);
        }
